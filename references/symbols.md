...
## A 股常用符号（AStockProvider）

使用 `AStockProvider` 拉取，需安装 `akshare`。个股历史行情使用 `AStockHistoryQuery(symbol=...)`，指数使用 `AStockIndexQuery(symbol=...)`。

### A 股指数

| 符号 | 标的 | 信号含义 |
|------|------|---------|
| `sh000001` | 上证指数 | 沪市整体风险偏好 |
| `sh000300` | 沪深300 | 大盘蓝筹和机构资产偏好 |
| `sh000016` | 上证50 | 核心权重/中特估/大金融代理 |
| `sh000905` | 中证500 | 中盘成长和周期扩散 |
| `sz399001` | 深证成指 | 深市整体风险偏好 |

### A 股龙头示例

| 符号 | 标的 | 信号含义 |
|------|------|---------|
| `600519` | 贵州茅台 | 高端消费/核心资产风险偏好 |
| `601318` | 中国平安 | 保险和金融风险偏好 |
| `600036` | 招商银行 | 银行资产质量和信用周期 |
| `601398` | 工商银行 | 大金融/红利/中特估 |
| `601857` | 中国石油 | 能源和高股息 |
| `600900` | 长江电力 | 公用事业/红利防御 |
| `600030` | 中信证券 | 券商和市场成交活跃度 |
| `600276` | 恒瑞医药 | 医药创新风险偏好 |
| `601012` | 隆基绿能 | 光伏产业链 |
| `600150` | 中国船舶 | 军工/造船周期 |
| `300750` | 宁德时代 | 创业板新能源/动力电池 |
| `300760` | 迈瑞医疗 | 创业板医疗器械 |
| `688981` | 中芯国际 | 科创板半导体制造 |
| `688111` | 金山办公 | 科创板软件 |

### 行业板块名称

常用 `AStockSectorHistoryQuery(symbol=...)` 拉取：`银行`、`证券`、`保险`、`白酒`、`煤炭行业`、`电力行业`、`公用事业`、`军工`、`半导体`、`医药商业`、`中药`、`有色金属`、`房地产开发`。
